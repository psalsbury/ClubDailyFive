...
$page=$pages[$slug];
if (($_SERVER['HTTP_X_CLUBDAILYFIVE_OVERLAY'] ?? '') === '1') {
 echo '<div class="eyebrow">ClubDailyFive.com</div><h1 id="infoTitle">'.htmlspecialchars($page['title'], ENT_QUOTES, 'UTF-8').'</h1>'.$page['body'];
 exit;
}
